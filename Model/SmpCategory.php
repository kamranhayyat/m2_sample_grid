...
class SmpCategory extends \Magento\Framework\Model\AbstractModel implements SmpCategoryInterface {

    const CACHE_TAG = 'smpmarketplace_category';
 
    protected $_cacheTag = 'smpmarketplace_category';
 
    protected $_eventPrefix = 'smpmarketplace_category';

    protected function _construct(){
        $this->_init('SMP\Grid\Model\ResourceModel\SmpCategory');
    }
