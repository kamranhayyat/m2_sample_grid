...
class AddSubRow extends \Magento\Backend\App\Action
{
    /**
    ...
    public function __construct(
        ...
        \SMP\Grid\Model\SmpSubCategoryFactory $smpCatFactory
    ) {
    ...
    public function execute()
    {
        ...
        if ($rowId) {
           ...
           if (!$rowData->getId()) {
               ...
               $this->_redirect('grid/subgrid/rowdata');
               return;
           }
       }
    ...
    {
        return $this->_authorization->isAllowed('SMP_Grid::add_sub_row');
    }
}